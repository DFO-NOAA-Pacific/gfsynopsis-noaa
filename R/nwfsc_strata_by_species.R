...
nwfsc_strata_by_species <- function() {
  strata_to_use <- rbind(
    ...
    c("canary rockfish", "strata 34.5-49 250"),
    c("chilipepper", "strata 32.5-46 400"),
    c("darkblotched rockfish", "strata 34.5-49 450"),
    c("Dover sole", "strata cw deep"),
    c("lingcod", "strata cw 350"),
    c("longspine thornyhead", "strata cw deep 375-1280"),
